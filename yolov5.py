...
from nets_v5.yolo import YoloBody
from utils_v5.utils import (cvtColor, get_anchors, get_classes, preprocess_input,
                         resize_image, show_config)
from utils_v5.utils_bbox import DecodeBox, DecodeBoxNP
...
class YOLO(object):
    _defaults = {
        ...
        # --------------------------------------------------------------------------#
        "model_path": 'logs_v5s/best_epoch_weights.pth',
