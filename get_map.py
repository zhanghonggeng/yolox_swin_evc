...
if __name__ == "__main__":
    ...
    image_val_ids = open(os.path.join(VOCdevkit_path,"VOC2007/ImageSets/Main/val.txt")).read().strip().split()
    ...
    if map_mode == 0 or map_mode == 1:
        ...
        # DOTA 验证集map
        for image_id in tqdm(image_val_ids):
            #image_path = os.path.join(VOCdevkit_path, "VOC2007/JPEGImages/" + image_id + ".jpg")
            # DOTA 验证集图片路径
            image_path = os.path.join(DOTA_PTAH, "DOTA_V1.0/val/images/" + image_id + ".png")
    ...
    if map_mode == 0 or map_mode == 2:
        ...
        for image_id in tqdm(image_val_ids):
            with open(os.path.join(map_out_path, "ground-truth/" + image_id + ".txt"), "w") as new_f:
                ...
                # DOTA 验证集 xml路径
                root = ET.parse(os.path.join(DOTA_PTAH,"DOTA_V1.0/val/labelTxt-v1.0/xml/" + image_id + ".xml")).getroot()
